...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()(
  {
    head: () => ({
      meta: [
        ...
        { title: "Precise Industries — Precision Machining, Pune" },
        {
          name: "description",
          content:
            "Precision machining, grinding, die and mould components, and hard chrome plating from Pune.",
        },
        { name: "author", content: "Precise Industries" },
