export const COMPANY = {
  ...
  tagline: "Precision machining, grinding & die-mould components",
  founded: 2025,
...
export const SERVICES = [
  {
    ...
    title: "VMC Machining",
    summary:
      "FANUC-controlled vertical machining centres for precision components in batch or prototype volumes.",
    points: [
      "3-axis FANUC VMC",
      "Prototype to batch runs",
  ...
  },
  {
    ...
    summary:
      "Machining of die and mould inserts, plates and detail components to drawing.",
  ...
  },
  {
    ...
    summary:
      "Precision machining of aluminium, mild steel and high-strength alloy components.",
...
export const PROCESS = [
  {
    step: "01",
    title: "Drawing & enquiry",
    body: "Share your 2D/3D drawing or sample. We review material, tolerance and finish requirements.",
  },
  {
    step: "02",
    title: "Quotation",
    body: "A costed, method-backed quotation with a committed delivery date — usually within 24–48 hours.",
  },
  {
    step: "03",
    title: "Manufacturing",
    body: "Machining and fitting executed in-house with stage-wise dimensional checks.",
  },
  {
    step: "04",
    title: "Inspection & dispatch",
    body: "Final inspection against drawing, documented, packed and dispatched on schedule.",
  },
];
